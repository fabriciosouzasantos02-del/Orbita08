...
const corrections: Partial<Record<Language, Record<string, string>>> = {
  ...
  de: {
    ...
    tarotSoulMirror: 'Wisse, dass das Tarot ein Spiegel unserer Seele ist und das gesamte Spektrum menschlicher Erfahrung durch Archetypen widerspiegelt. Es ist eine der ältesten Verbindungen zwischen Menschen und dem Göttlichen, die dazu dient, uns etwas Höherem näher zu bringen. Sein Studium stellt eine Reise der inneren Entdeckung dar.'
  },
  fr: {
