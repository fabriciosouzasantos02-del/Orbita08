...
const AstrologyView = memo(function AstrologyView({ mapData, user, onUpdateMainMap, readOnly = false }: AstrologyViewProps) {
  ...
  const LOCAL_UI_TRANSLATIONS: Record<string, Record<string, string>> = {
    en: {
      ...
      "Ver menos": "Show less",
      "Ler mais": "Read more",
      "Diagrama do firmamento no nascimento": "Firmament diagram at birth",
      ...
      "3. Polaridade Energética": "3. Energetic Polarity",
    ...
    de: {
      ...
      "Ler mais": "Mehr lesen",
      "Diagrama do firmamento no nascimento": "Firmamentdiagramm bei der Geburt",
      "1. Distribuição dos Elementos": "1. Verteilung der Elemente",
      "Fogo (Entusiasmo & Energia)": "Feuer (Enthusiasmus & Energie)",
      "Terra (Praticidade & Conquistas)": "Erde (Praxisnähe & Errungenschaften)",
      ...
      "DNA Astral & Pesos de Personalidade": "Astrale DNA & Persönlichkeitsgewichte",
      "Este quadro mostra a condição que cada signo, planeta e casa possui em seu mapa astral, sendo parte integrante das informações que você leu acima. Você já se perguntou por quê algumas pessoas atribuem pesos diferentes para os diversos aspectos de sua personalidade ou desprendem mais ou menos energia em uma determinada área da vida? Isso acontece pois como você acompanhou até aqui, há diversas forças em jogo. Todo mapa astral é uma mistura variada de energias que criam uma configuração única, como uma espécie de DNA astral.": "Diese Übersicht zeigt den Zustand, den jedes Zeichen, jeder Planet und jedes Haus in Ihrem Geburtshoroskop einnimmt, und ist ein wesentlicher Bestandteil der oben gelesenen Informationen. Haben Sie sich jemals gefragt, warum manche Menschen verschiedenen Aspekten ihrer Persönlichkeit unterschiedliche Gewichte beimessen oder mehr oder weniger Energie in einem bestimmten Lebensbereich aufwenden? Dies geschieht, weil, wie Sie bisher gesehen haben, verschiedene Kräfte im Spiel sind. Jedes Geburtshoroskop ist eine vielfältige Mischung aus Energien, die eine einzigartige Konfiguration bilden, wie eine Art astrale DNA.",
      "Força": "Stärke",
      "Harmonia": "Harmonie",
      "Fogo": "Feuer",
      "Terra": "Erde",
    ...
    fr: {
      ...
      "Terra (Praticidade & Conquistas)": "Terre (Praticité & Réalisations)",
